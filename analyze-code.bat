@echo off
REM Script d'analyse de qualité de code pour Consultator (Windows)

echo 🔍 Analyse de la qualité du code Consultator
echo ================================================

REM Créer le dossier reports s'il n'existe pas
if not exist reports mkdir reports

REM Installation des outils si nécessaire
