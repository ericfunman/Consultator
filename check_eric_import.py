...
def check_eric_lapina_import():
    ...
    with get_database_session() as session:
        ...
        eric_consultant = session.query(Consultant).filter(
        ...
        if eric_consultant:
            ...
            print(f'  Pratique: {eric_consultant.practice.nom if eric_consultant.practice else "Aucune"}')
            print(f'  Type contrat: {eric_consultant.type_contrat}')
            print(f'  Salaire: {eric_consultant.salaire_actuel}')
            print(f'  Business Manager: {eric_consultant.business_manager_actuel.nom_complet if eric_consultant.business_manager_actuel else "Aucun"}')
        else:
