...
class TestBusinessManagersBasic:
    ...
    def test_show_with_profile_view(self, mock_st):
        ...
        with patch(
            "app.pages_modules.business_managers.show_bm_profile"
        ) as mock_show_profile:
    ...
    def test_show_business_managers_list_with_data(
        self,
    ...
    def test_show_add_business_manager_validation_error(self, mock_session, mock_st):
        ...
        with patch("streamlit.form") as mock_form:
            ...
            mock_st.text_input.side_effect = [
                ...
                "",
                "",
            ]  # nom, email, prenom, telephone vides
    ...
    def test_show_statistics_basic(self, mock_session, mock_st):
        ...
        # Mock les compteurs
        mock_session_instance.query.return_value.count.side_effect = [
            5,
            3,
            12,
        ]  # total_bms, active_bms, assignments
