...
def init_langues():
    ...
    langues_base = [
        ...
        {"nom": "Chinois Mandarin", "code_iso": "ZH", "description": "Chinois mandarin"},
...
def add_sample_consultant_languages():
    ...
    try:
        from database.models import Consultant, ConsultantLangue
        ...
        for i, consultant in enumerate(consultants):
            ...
            existing_fr = session.query(ConsultantLangue).filter(
            ...
            existing_en = session.query(ConsultantLangue).filter(
                ConsultantLangue.consultant_id == consultant.id,
            ...
            if espagnol and i % 2 == 0:  # 1 consultant sur 2
                existing_es = session.query(ConsultantLangue).filter(
                    ConsultantLangue.consultant_id == consultant.id,
