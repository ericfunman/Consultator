...
def edit_mission_form(mission, key_prefix):
    ...
    technologies = technology_multiselect(
        ...
        current_technologies=(
            ", ".join(mission.technologies_utilisees.split(", "))
...
def show_add_mission_form(consultant):
    ...
    technologies_str = technology_multiselect(
        label="🛠️ Technologies", key="new_mission_tech", current_technologies=""
    )
            ...
            if event.selection.rows:
                ...
                with col3:
                    if st.button(
                        ...
                        if st.button(
                            "Confirmer la suppression", type="secondary"
                        ):
                            try:
                                ConsultantService.delete_consultant(
                                    selected_consultant_id
                                )
                                st.success(
