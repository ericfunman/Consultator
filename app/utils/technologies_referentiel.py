...
TECHNOLOGIES_REFERENTIEL: Dict[str, List[str]] = {
    ...
    "Frameworks Web": [
        ...
        "ASP.NET", "ASP.NET Core", ".NET Framework", ".NET 5+",
        "Gin", "Echo", "Fiber",
        "Play Framework",
        "Phoenix"
    ],
    ...
    "Bases de données": [
        ...
        "Oracle Database", "Oracle 11g", "Oracle 12c", "Oracle 19c", "Oracle 21c",
    ...
    "Sécurité": [
        ...
        "Penetration Testing", "OWASP", "Security Scanning",
