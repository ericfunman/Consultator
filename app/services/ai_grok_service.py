...
class GrokAIService:
    ...
    def analyze_cv(self, document_text: str, consultant_name: str = "") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            prompt = self._build_analysis_prompt(document_text, consultant_name)
            ...
            raise Exception(f"❌ Échec de l'analyse IA: {str(e)}")

    def _build_analysis_prompt(self, document_text: str, consultant_name: str = "") -> str:
...
Réponds UNIQUEMENT avec du JSON valide, rien d'autre."""
    ...
    def _call_grok_api(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Erreur API Grok: {str(e)}")
    ...
    def _parse_and_validate_response(self, api_response: Dict[str, Any], original_text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception("❌ La réponse de Grok n'est pas un JSON valide")

        except KeyError as e:
            logger.error(f"Structure de réponse inattendue: {e}")
            raise Exception("❌ Structure de réponse Grok inattendue")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"❌ Erreur: {e}")</content>
<parameter name="filePath">c:\Users\b302gja\Documents\Consultator en cours\Consultator\app\services\ai_grok_service.py