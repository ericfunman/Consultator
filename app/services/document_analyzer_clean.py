...
class DocumentAnalyzer:
    ...
    def _extract_missions(text: str) -> List[Dict]:
        ...
        sorted_missions = sorted(unique_missions, key=lambda x: DocumentAnalyzer._date_sort_key(x.get('date_debut', '')), reverse=True)
    ...
    def _extract_technical_skills(text: str) -> List[str]:
        ...
        programming_languages = [
            ...
            'scala', 'kotlin', 'swift', 'sql', 'html', 'css', 'sass', 'xml', 'json'
        ]
