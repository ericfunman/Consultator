...
class DocumentService:
    ...
    def save_uploaded_file(
        cls, uploaded_file, consultant_id: int
    ) -> Dict[str, Any]:
        """
    ...
    def extract_text_from_file(cls, file_path: str) -> str:
        ...
        if extension == "pdf":
            ...
            return f"Format {extension.upper()} détecté mais nécessite une conversion vers {extension}x pour l'extraction de texte."
        else:
                        ...
                        documents.append(
                            {
                                ...
                                "extension": cls.get_file_extension(
                                    file_path.name
                                ),
