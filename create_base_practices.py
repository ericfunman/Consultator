...
def create_base_practices():
    ...
    practices_data = [
        {'nom': 'Data & Analytics', 'description': 'Expertise en data science, BI, analytics'},
        {'nom': 'Digital & Innovation', 'description': 'Transformation digitale, innovation'},
        {'nom': 'Finance & Risk', 'description': 'Finance, risk management, compliance'},
        {'nom': 'IT & Infrastructure', 'description': 'Architecture IT, cloud, infrastructure'},
        {'nom': 'Management & Strategy', 'description': 'Conseil en management, stratégie'},
        {'nom': 'Operations & Supply Chain', 'description': 'Optimisation opérationnelle, supply chain'},
        {'nom': 'RH & Organisation', 'description': 'Ressources humaines, organisation'},
