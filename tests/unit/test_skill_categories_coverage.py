...
class TestSkillCategoriesCoverage:
    ...
    def test_comprehensive_category_coverage(self):
        ...
        expected_tech = [
            "Backend", "Frontend", "Mobile", "Data & Analytics",
            "Cloud & DevOps", "Base de données", "Architecture & Design",
            "Sécurité", "Outils & Méthodologies", "IA & Machine Learning"
        ]
        ...
        expected_func = [
            "Banque de Détail", "Banque d'Affaires & Corporate",
            "Marchés Financiers", "Crédit & Risques", "Assurance Vie",
            "Assurance Non-Vie", "Réassurance", "Produits Financiers",
            "Réglementation Bancaire", "Réglementation Assurance",
            "Compliance & AML"
        ]
