...
class TestTargetedCoverageBoost(unittest.TestCase):
    ...
    def test_consultant_cv_functions(self, mock_error, mock_uploader, mock_session):
        ...
        try:
            from app.pages_modules.consultant_cv import show, upload_cv_file, process_cv_analysis
    ...
    def test_main_navigation_branches(self, mock_session, mock_sidebar):
        ...
        try:
            ...
            # Test fonction main
            with patch("app.main.show_navigation"), patch("app.main.load_module_safe", return_value=MagicMock()):
                main()
