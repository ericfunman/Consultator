...
class TestAggressiveCoveragePush(unittest.TestCase):
    ...
    def test_consultant_documents_aggressive(self):
        ...
        try:
            ...
            available_functions = [attr for attr in dir(cd_module) if not attr.startswith('_') and callable(getattr(cd_module, attr))]
    ...
    def test_consultants_page_aggressive(self):
        ...
        try:
            ...
            main_functions = [attr for attr in dir(consultants_module) 
    ...
    def test_enhanced_ui_aggressive(self):
        ...
        try:
            ...
            public_functions = [attr for attr in dir(ui_module) 
                              if not attr.startswith('_') and callable(getattr(ui_module, attr))]
            ...
            # Test des constantes
            constants = [attr for attr in dir(ui_module) 
    ...
    def test_helpers_aggressive(self):
        ...
        try:
            ...
            # Test de toutes les fonctions publiques
            public_functions = [attr for attr in dir(helpers) 
            ...
            # Test des constantes
            constants = [attr for attr in dir(helpers) 
                        if not attr.startswith('_') and not callable(getattr(helpers, attr))]
    ...
    def test_technology_widget_aggressive(self):
        ...
        try:
            ...
            # Test des méthodes principales
            methods_to_test = ['render', 'update_technologies', 'get_selected_technologies', 
                             'add_technology', 'remove_technology', 'clear_selection']
