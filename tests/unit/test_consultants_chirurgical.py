...
class TestConsultantsChirurgical(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.streamlit_patcher = patch(
            "streamlit.cache_data", side_effect=lambda func=None, **kwargs: func if func else lambda f: f
        )
    ...
    def test_display_consultant_header(self, mock_columns, mock_write):
        ...
        mock_columns.return_value = [Mock(), Mock()]
        mock_data = {"consultant": Mock(), "business_manager": Mock(), "current_practice_id": 1}
    ...
    def test_render_basic_consultant_fields(self, mock_date, mock_select, mock_text):
        ...
        try:
            ...
            result = _render_basic_consultant_fields(mock_consultant, mock_practices, mock_managers)
