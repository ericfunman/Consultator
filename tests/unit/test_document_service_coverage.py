...
class TestDocumentServiceCoverage:
    ...
    def test_extract_text_from_file_os_error(self):
        ...
        with patch.object(DocumentService, '_extract_text_from_pdf', side_effect=OSError("File not found")):
    ...
    def test_extract_text_from_file_io_error(self):
        ...
        with patch.object(DocumentService, '_extract_text_from_docx', side_effect=IOError("Access denied")):
    ...
    def test_extract_text_from_file_value_error(self):
        ...
        with patch.object(DocumentService, '_extract_text_from_pdf', side_effect=ValueError("Invalid PDF")):
