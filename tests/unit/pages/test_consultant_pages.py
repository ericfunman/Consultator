...
class TestPageNavigation:
    ...
    def test_page_url_parameters(self):
        ...
        test_params = {"page": "consultant_profile", "id": "123", "tab": "competences"}
...
class TestPageIntegration:
    ...
    def test_consultant_list_service_integration(self, mock_get_consultants):
        ...
        mock_consultants = [{"id": 1, "nom": "Dupont", "prenom": "Jean"}, {"id": 2, "nom": "Martin", "prenom": "Marie"}]
...
class TestPagePerformance:
    ...
    def test_page_load_time_simulation(self):
        ...
        test_data = []
        for i in range(100):
            test_data.append({"id": i, "nom": f"Consultant {i}", "email": f"consultant{i}@test.com"})
