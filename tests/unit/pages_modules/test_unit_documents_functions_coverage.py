...
class TestDocumentsFunctions:
    ...
    @patch('app.pages_modules.documents_functions.os.path.exists')
    def test_show_existing_documents_with_files(self, mock_exists, mock_listdir, mock_st):
    ...
    def test_save_consultant_document_success(self, mock_service, mock_st):
        ...
        try:
            ...
            # Test simulé
            def save_consultant_document(consultant_id, uploaded_file, document_type, description):
...
class TestDocumentIntegration:
    ...
    def test_document_listing_and_filtering(self):
        ...
        documents = [
            ...
            {"name": "letter.docx", "type": "Letter", "size": 2048, "date": "2024-01-20"},
            {"name": "cert.pdf", "type": "Certificate", "size": 512, "date": "2024-01-25"},
        ]
