...
class TestConsultantDocumentsIntensive(unittest.TestCase):
    ...
    def test_show_consultant_documents_full_flow(
        self, mock_expander, mock_button, mock_columns, mock_info, mock_markdown, mock_session
    ):
        ...
        mock_session.return_value.__enter__.return_value.query.return_value.filter.return_value.order_by.return_value = (
            mock_query_result
        )
    ...
    def test_upload_document_flow(self, mock_submit, mock_text, mock_select, mock_form, mock_uploader):
