...
class TestHomeMegaCoverage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.db_info_exists = {"exists": True, "consultants": 25, "missions": 45, "practices": 5}

        self.db_info_not_exists = {"exists": False, "consultants": 0, "missions": 0}

        self.db_info_empty = {"exists": True, "consultants": 0, "missions": 0}
    ...
    def test_show_database_initialization_button_clicked(
        self, mock_rerun, mock_success, mock_button, mock_error, mock_title, mock_get_db_info
    ):
    ...
    def test_show_with_empty_database(
        self, mock_markdown, mock_metric, mock_columns, mock_title, mock_getting_started, mock_get_db_info
    ):
    ...
    def test_show_with_data(
        self, mock_markdown, mock_metric, mock_columns, mock_title, mock_dashboard_charts, mock_get_db_info
    ):
    ...
    def test_metrics_values_display(self, mock_metric, mock_columns, mock_title, mock_get_db_info):
        ...
        expected_calls = [
            unittest.mock.call(label="👥 Consultants", value=25, delta="Actifs dans la practice"),
            unittest.mock.call(label="💼 Missions", value=45, delta="En cours et terminées"),
            unittest.mock.call(label="📊 Taux d'occupation", value="85%", delta="2%"),
        ]
    ...
    def test_show_dashboard_charts_basic(self, mock_dataframe, mock_plotly_chart, mock_subheader, mock_columns):
    ...
    @patch("app.pages_modules.home.st.plotly_chart")
    @patch("streamlit.dataframe")
    def test_show_dashboard_charts_data_generation(
        self, mock_dataframe, mock_plotly_chart, mock_subheader, mock_columns
    ):
    ...
    @patch("streamlit.dataframe")
    def test_show_dashboard_charts_revenue_generation(
        self, mock_dataframe, mock_px_line, mock_plotly_chart, mock_subheader, mock_columns
    ):
    ...
    def test_show_getting_started_structure(
        self, mock_expander, mock_button, mock_markdown, mock_container, mock_columns, mock_subheader
    ):
    ...
    @patch("streamlit.expander")
    def test_show_getting_started_button_click(
        self, mock_expander, mock_switch_page, mock_button, mock_markdown, mock_container, mock_columns, mock_subheader
    ):
    ...
    @patch("app.pages_modules.home.st.button")
    @patch("streamlit.expander")
    def test_show_getting_started_content_verification(
        self, mock_expander, mock_button, mock_markdown, mock_container, mock_columns, mock_subheader
    ):
        ...
        expected_subheaders = ["🚀 Commencez avec Consultator", "⚡ Actions rapides"]
    ...
    @patch("app.pages_modules.home.st.metric")
    @patch("app.pages_modules.home.st.markdown")
    def test_integration_flow_with_data(
        self, mock_markdown, mock_metric, mock_columns, mock_title, mock_dashboard_charts, mock_get_db_info
    ):
    ...
    @patch("app.pages_modules.home.st.metric")
    @patch("app.pages_modules.home.st.markdown")
    def test_integration_flow_without_data(
        self, mock_markdown, mock_metric, mock_columns, mock_title, mock_getting_started, mock_get_db_info
    ):
