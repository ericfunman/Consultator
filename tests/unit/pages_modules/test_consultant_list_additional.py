...
class TestConsultantListAdditionalCoverage(unittest.TestCase):
    ...
    def test_apply_filters_search_term(self):
        ...
        result = _apply_filters(
            self.sample_df, search_term="Jean", practice_filter="Tous", entite_filter="Tous", availability_filter="Tous"
        )
    ...
    def test_apply_filters_entite_filter(self):
        ...
        result = _apply_filters(
            self.sample_df, search_term="", practice_filter="Tous", entite_filter="France", availability_filter="Tous"
        )
    ...
    def test_create_search_filters_with_data(self):
        ...
        with patch("streamlit.text_input") as mock_text, patch("streamlit.selectbox") as mock_select, patch(
            "streamlit.slider"
        ) as mock_slider, patch("streamlit.columns") as mock_columns:
