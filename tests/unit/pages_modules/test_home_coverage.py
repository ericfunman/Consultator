...
class TestHomeCoverage:
    ...
    def test_show_initialize_database_success(self, mock_get_db_info, mock_st):
        ...
        with patch('app.pages_modules.home.init_database') as mock_init_db:
            ...
            mock_st.success.assert_called_once_with("✅ Base de données initialisée avec succès !")
    ...
    def test_show_with_database_exists_full_dashboard(self, mock_get_db_info, mock_st):
        ...
        with patch('app.pages_modules.home.ConsultantService') as mock_consultant_service, \
             patch('app.pages_modules.home.PracticeService') as mock_practice_service, \
             patch('app.pages_modules.home.pd') as mock_pd, \
             patch('app.pages_modules.home.px') as mock_px:
    ...
    def test_show_with_service_errors(self, mock_get_db_info, mock_st):
        ...
        with patch('app.pages_modules.home.ConsultantService') as mock_consultant_service, \
            ...
            mock_consultant_service.get_consultants_stats.side_effect = Exception("Service error")
            mock_practice_service.get_practice_statistics.side_effect = Exception("Service error")
    ...
    def test_show_performance_with_large_dataset(self, mock_get_db_info, mock_st):
        ...
        with patch('app.pages_modules.home.ConsultantService') as mock_consultant_service, \
            ...
            large_practices_detail = [
                {"nom": f"Practice {i}", "total_consultants": 200}
                for i in range(50)
            ]
