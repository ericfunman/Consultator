...
class TestMissionDataStructure:
    ...
    def test_mission_status_values(self):
        ...
        valid_statuses = [
            ...
            "Suspendue", "Annulée", "En validation"
        ]
...
class TestMissionForms:
    ...
    def test_mission_form_components(self, mock_submit, mock_multiselect, mock_number,
                                   mock_date, mock_selectbox, mock_text_area, 
...
class TestMissionFiltering:
    ...
    def test_mission_date_filter(self):
        ...
        # Données de test
        missions = [
            {"nom": "Mission 1", "date_debut": date(2024, 1, 1), "date_fin": date(2024, 6, 30)},
            {"nom": "Mission 2", "date_debut": date(2023, 1, 1), "date_fin": date(2023, 12, 31)},
            {"nom": "Mission 3", "date_debut": date(2024, 7, 1), "date_fin": date(2024, 12, 31)}
        ]
...
class TestMissionExport:
    ...
    def test_mission_export_csv(self, mock_download):
        ...
        # Vérifications
        mock_download.assert_called_with("Télécharger CSV", csv_data, "missions.csv", "text/csv")
