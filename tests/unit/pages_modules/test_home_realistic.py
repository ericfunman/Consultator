...
class TestHomeFunctional(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.db_info_with_data = {"exists": True, "consultants": 25, "missions": 15, "revenues": 120000}

        self.db_info_empty = {"exists": True, "consultants": 0, "missions": 0, "revenues": 0}

        self.db_info_not_exists = {"exists": False}
    ...
    def test_show_with_data(self, mock_get_db_info, mock_title, mock_columns, mock_metric, mock_markdown, mock_charts):
    ...
    @patch("app.pages_modules.home.st.title")
    @patch("app.pages_modules.home.get_database_info")
    def test_show_with_empty_data(
        self, mock_get_db_info, mock_title, mock_columns, mock_metric, mock_markdown, mock_getting_started
    ):
    ...
    def test_show_getting_started(
        self, mock_subheader, mock_columns, mock_container, mock_markdown, mock_button, mock_expander, mock_switch_page
    ):
    ...
    @patch("app.pages_modules.home.st.columns")
    def test_show_dashboard_charts(self, mock_columns, mock_plotly_chart, mock_subheader, mock_dataframe):
