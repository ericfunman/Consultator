...
class TestPracticesUltraSimple(unittest.TestCase):
    ...
    @patch("app.pages_modules.practices.PracticeService")
    def test_handle_assign_consultant_ultra_simple(self, mock_service, mock_success, 
                                                  mock_button, mock_columns):
    ...
    def test_display_consultants_simple_list_ultra_simple(self, mock_columns):
        ...
        consultant_data = [{"Prénom": "Jean", "Nom": "Dupont", "Grade": "Senior", "Email": "jean@test.com", "Salaire": "50000€"}]
