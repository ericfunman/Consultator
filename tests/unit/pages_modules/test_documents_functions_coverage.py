...
from app.pages_modules.documents_functions import _render_document_actions
from app.pages_modules.documents_functions import _render_document_metrics
    ...
    def test_show_consultant_documents_complete_flow(self, mock_show_existing, mock_save_doc, mock_st):
        ...
        mock_st.columns.side_effect = [
            [
                ...
                MagicMock(),
                MagicMock(),
            ],  # First call: 3 columns for metrics
...
class TestIntegrationScenarios:
    ...
    def test_full_upload_workflow(self, mock_show_existing, mock_doc_service, mock_st):
        ...
        mock_st.button.side_effect = [
            ...
            False,
            False,
        ]  # Save clicked, Cancel not, Analyze not
