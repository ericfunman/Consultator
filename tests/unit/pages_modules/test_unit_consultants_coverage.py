...
class TestShowFunction:
    ...
    def test_show_basic_structure(self, mock_list, mock_profile, mock_cv, mock_tabs, mock_title):
...
class TestCVAnalysisFullwidth:
    ...
    def test_cv_analysis_no_file(self, mock_success, mock_button, mock_uploader, mock_subheader):
    ...
    def test_cv_analysis_with_file_imports_ko(self, mock_error, mock_button, mock_uploader, mock_subheader):
    ...
    def test_cv_analysis_with_file_success(self, mock_analyzer_class, mock_json, mock_success, 
                                          mock_button, mock_uploader, mock_subheader):
...
class TestConsultantProfile:
    ...
    def test_consultant_profile_no_consultant(self, mock_get_all, mock_missions, mock_languages, 
                                            mock_skills, mock_info, mock_selectbox, mock_subheader):
    ...
    @patch('app.pages_modules.consultants.show_consultant_missions')
    @patch('app.services.consultant_service.ConsultantService.get_all_consultants')
    def test_consultant_profile_with_consultant(self, mock_get_all, mock_missions, mock_languages, 
                                              mock_skills, mock_info, mock_tabs, mock_selectbox, mock_subheader):
...
class TestConsultantInfo:
    ...
    def test_consultant_info_display_mode(self, mock_submit, mock_text_area, mock_number, 
                                        mock_date, mock_selectbox, mock_text_input, 
                                        mock_form, mock_markdown):
    ...
    def test_consultant_info_update_success(self, mock_update, mock_submit, mock_text_area, 
                                          mock_number, mock_date, mock_selectbox, 
                                          mock_text_input, mock_form, mock_error, mock_success):
        ...
        mock_text_input.side_effect = ["Dupont", "Jean", "jean.dupont@example.com", "0123456789"]
...
class TestConsultantSkills:
    ...
    def test_show_consultant_skills(self, mock_add_form, mock_functional, mock_technical, mock_subheader):
    ...
    def test_show_technical_skills_with_data(self, mock_delete, mock_button, mock_dataframe, mock_markdown):
...
class TestConsultantLanguages:
    ...
    def test_show_consultant_languages_with_data(self, mock_add_form, mock_button, mock_dataframe, mock_subheader):
    ...
    @patch('streamlit.info')
    @patch('app.pages_modules.consultants._add_language_form')
    def test_show_consultant_languages_no_data(self, mock_add_form, mock_info, mock_subheader):
    ...
    def test_add_language_form_success(self, mock_save, mock_success, mock_submit, 
                                     mock_text_area, mock_selectbox, mock_form):
...
class TestConsultantMissions:
    ...
    def test_show_consultant_missions_no_data(self, mock_add_form, mock_info, mock_subheader):
    ...
    @patch('app.pages_modules.consultants.show_add_mission_form')
    def test_show_consultant_missions_with_data(self, mock_add_form, mock_readonly, mock_tabs, mock_subheader):
...
class TestConsultantsList:
    ...
    @patch('streamlit.error')
    @patch('app.services.consultant_service.ConsultantService.get_all_consultants')
    def test_consultants_list_imports_ko(self, mock_get_all, mock_error, mock_info, mock_subheader):
    ...
    @patch('streamlit.markdown')
    @patch('app.services.consultant_service.ConsultantService.get_all_consultants')
    def test_consultants_list_with_data(self, mock_get_all, mock_markdown, mock_dataframe, mock_subheader):
...
class TestUtilityFunctions:
    ...
    def test_save_consultant_competence_success(self, mock_session, mock_error, mock_success):
    ...
    @patch('streamlit.error')
    @patch('app.database.database.get_database_session')
    def test_delete_consultant_competence_success(self, mock_session, mock_error, mock_success):
    ...
    @patch('streamlit.error')
    @patch('app.database.database.get_database_session')
    def test_save_consultant_language_success(self, mock_session, mock_error, mock_success):
    ...
    @patch('streamlit.error')
    @patch('app.database.database.get_database_session')
    def test_delete_consultant_language_success(self, mock_session, mock_error, mock_success):
