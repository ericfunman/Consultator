...
class TestBusinessManagersHyperTargeted(unittest.TestCase):
    ...
    def test_show_bm_consultants_management_full(self, mock_comment, mock_selection, mock_assignments, mock_st, mock_columns):
    ...
    def test_handle_assignment_selection_with_end(self, mock_end, mock_st, mock_columns):
        ...
        data = [{
            ...
            "Date début": date.today().strftime("%d/%m/%Y"), 
            "Commentaire": "Test"
        }]
        mock_session = Mock()
