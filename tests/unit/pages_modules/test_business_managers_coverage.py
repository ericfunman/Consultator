...
class TestBusinessManagersCoverage(unittest.TestCase):
    ...
    def test_display_bm_header_and_info(self, mock_rerun, mock_markdown, mock_button, mock_title, mock_columns):
    ...
    @patch("streamlit.markdown")
    @patch("streamlit.rerun")
    def test_display_bm_header_and_info_with_button_click(
        self, mock_rerun, mock_markdown, mock_button, mock_title, mock_columns
    ):
    ...
    @patch("streamlit.markdown")
    def test_show_bm_profile_valid_id(
        self,
        mock_markdown,
        mock_get_session,
        mock_handle_actions,
        mock_display_general,
        mock_display_header,
        mock_validate_id,
    ):
    ...
    @patch("streamlit.error")
    def test_show_edit_bm_form_not_submitted(
        self, mock_error, mock_success, mock_submit, mock_checkbox, mock_text_input, mock_form
    ):
    ...
    @patch("streamlit.rerun")
    @patch("app.pages_modules.business_managers.get_database_session")
    def test_show_edit_bm_form_submitted_success(
        self,
        mock_get_session,
        mock_rerun,
        mock_error,
    ...
    def test_show_business_managers_list_basic(
        self,
        mock_get_all_bm,
        mock_button,
        mock_text_input,
    ...
    @patch("app.pages_modules.business_managers.get_database_session")
    def test_show_statistics_basic(self, mock_get_session, mock_plotly_chart, mock_metric, mock_subheader):
    ...
    @patch("streamlit.rerun")
    @patch("app.pages_modules.business_managers.get_database_session")
    def test_show_add_business_manager_basic(
        self,
        mock_get_session,
        mock_rerun,
        mock_error,
