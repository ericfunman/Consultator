...
class TestChatbotServiceCoverage(TestCase):
    ...
    def test_extract_entities_basic(self, mock_session):
        ...
        # Execution
        chatbot = ChatbotService()
        result = chatbot._extract_entities("Qui connaît Python et travaille chez Google?")
    ...
    def test_handle_salary_question_basic(self, mock_session):
        ...
        # Execution
        chatbot = ChatbotService()
        entities = {"noms": ["Python"], "entreprises": [], "competences": [], "langues": [], "montants": [], "practices": []}
    ...
    def test_handle_experience_question_basic(self, mock_session):
        ...
        # Execution
        chatbot = ChatbotService()
        entities = {"competences": ["Java"], "experience": ["5 ans"], "noms": [], "entreprises": [], "langues": [], "montants": [], "practices": []}
    ...
    def test_handle_skills_question_basic(self, mock_session):
        ...
        # Execution
        chatbot = ChatbotService()
        entities = {"competences": ["Python"], "noms": [], "entreprises": [], "langues": [], "montants": [], "practices": []}
    ...
    def test_handle_languages_question_basic(self, mock_session):
        ...
        # Mock query results
        mock_db.query.return_value.join.return_value.filter.return_value.all.return_value = [self.mock_consultant]
        
        # Execution
        chatbot = ChatbotService()
        entities = {"langues": ["Anglais"], "noms": [], "entreprises": [], "competences": [], "montants": [], "practices": []}
    ...
    def test_handle_missions_question_basic(self, mock_session):
        ...
        # Execution
        chatbot = ChatbotService()
        entities = {"entreprises": ["Test Corp"], "noms": [], "competences": [], "langues": [], "montants": [], "practices": []}
    ...
    def test_get_missions_by_consultant_success(self, mock_session):
        ...
        # Mock query results
        mock_db.query.return_value.filter.return_value.order_by.return_value.all.return_value = [self.mock_mission]
    ...
    def test_extract_entities_comprehensive(self, mock_session):
        ...
        for question in test_questions:
            ...
            expected_keys = ["noms", "entreprises", "competences", "langues", "montants", "practices"]
            for key in expected_keys:
                assert key in result
                assert isinstance(result[key], list)
    ...
    def test_handle_salary_question_no_salary(self, mock_session):
        ...
        mock_db.query.return_value.filter.return_value.first.return_value = consultant_no_salary
    ...
    def test_multiple_entity_extraction_patterns(self, mock_session):
        ...
        mock_db.query.return_value.all.return_value = [self.mock_consultant, mock_consultant_2]
