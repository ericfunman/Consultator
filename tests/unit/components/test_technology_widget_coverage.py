...
from app.components.technology_widget import (
    _parse_current_technologies,
    _add_custom_technology_if_needed,
    _render_add_technology_form,
    _handle_add_technology,
    _render_multiselect_interface,
    _render_technologies_search_tab,
    _display_search_results,
    _display_technologies_by_category,
    _render_add_technology_tab,
    _render_add_technology_form_main,
    _handle_form_submission,
    _display_custom_technologies_list,
    _handle_delete_technology,
...
class TestDisplaySearchResults:
    ...
    def test_display_search_results(self, mock_tech_service, mock_st):
        ...
        mock_tech_service.search_technologies.return_value = ["Python", "PyTorch", "Pandas"]
...
class TestDisplayTechnologiesByCategory:
    ...
    def test_display_by_category(self, mock_st):
        ...
        expected_titles = ["📁 Langages (3 technologies)", "📁 Frameworks (2 technologies)"]
