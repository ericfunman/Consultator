...
class TestAdvancedUIFilters:
    ...
    def test_apply_filters_multiple_filters(self):
        ...
        data = [
            {
                "nom": "Dupont", "practice_name": "Digital", "grade": "Senior",
                "salaire_actuel": 55000, "experience_annees": 7
            },
            {
                "nom": "Martin", "practice_name": "Digital", "grade": "Junior",
                "salaire_actuel": 45000, "experience_annees": 3
            },
            {
                "nom": "Bernard", "practice_name": "Data", "grade": "Senior",
                "salaire_actuel": 60000, "experience_annees": 8
            }
        ]
...
class TestIntegrationEnhancedUI:
    ...
    def test_integration_filters_and_search(self):
        ...
        data = [
            {
                "nom": "Dupont", "prenom": "Jean", "practice_name": "Digital",
                "grade": "Senior", "salaire_actuel": 55000
            },
            {
                "nom": "Martin", "prenom": "Marie", "practice_name": "Data",
                "grade": "Junior", "salaire_actuel": 45000
            }
        ]
    ...
    def test_complex_filtering_scenario(self):
        ...
        data = [
            {
                "nom": "Dupont", "prenom": "Jean", "practice_name": "Digital",
                "grade": "Senior", "salaire_actuel": 65000, "experience_annees": 8,
                "societe": "Quanteam", "type_contrat": "CDI", "disponibilite": True
            },
            {
                "nom": "Martin", "prenom": "Marie", "practice_name": "Digital",
                "grade": "Junior", "salaire_actuel": 45000, "experience_annees": 3,
                "societe": "Quanteam", "type_contrat": "CDI", "disponibilite": False
            },
            {
                "nom": "Bernard", "prenom": "Paul", "practice_name": "Data",
                "grade": "Senior", "salaire_actuel": 70000, "experience_annees": 10,
                "societe": "Asigma", "type_contrat": "CDI", "disponibilite": True
            }
        ]
