...
def test_force_code_execution():
    ...
    try:
        ...
        print(f"⚠️ Erreur lors de l'exécution mais imports réussis: {e}")
        pass
...
def test_import_all_modules():
    ...
    for module_name in modules_to_import:
        try:
            ...
            print(f"⚠️ {module_name} - erreur d'import: {e}")
        except Exception as e:
...
def test_execute_main_functions():
    ...
    try:
        ...
        print(f"⚠️ Erreur fonctions skill_categories: {e}")
    ...
    try:
        ...
        print(f"⚠️ Erreur fonctions technologies_referentiel: {e}")
...
def test_database_operations():
    ...
    try:
        ...
        print(f"⚠️ Erreur database operations: {e}")
