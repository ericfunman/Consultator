...
class TestCreateConsultant:
    ...
    def test_create_consultant_success(self, mock_info, mock_error, mock_session):
        ...
        with patch('app.pages_modules.consultant_forms.Consultant', return_value=mock_consultant):
            data = {
                "prenom": "Jean",
                "nom": "Dupont",
                "email": "jean@test.com",
    ...
    def test_create_consultant_database_error(self, mock_error, mock_session):
        ...
        assert result is False
        mock_error.assert_called_with("❌ Erreur lors de la création du consultant: Database error")
...
class TestUpdateConsultant:
    ...
    def test_update_consultant_success(self, mock_info, mock_error, mock_session):
        ...
        mock_session_instance.query.return_value.filter.return_value.first.side_effect = [mock_consultant, None]
    ...
    def test_update_consultant_duplicate_email(self, mock_error, mock_session):
        ...
        mock_consultant = MagicMock()
        mock_consultant.id = 1
        mock_session_instance.query.return_value.filter.return_value.first.side_effect = [mock_consultant, MagicMock()]
    ...
    def test_update_consultant_database_error(self, mock_error, mock_session):
        ...
        assert result is False
        mock_error.assert_called_with("❌ Erreur lors de la modification du consultant: Database error")
...
class TestDeleteConsultant:
    ...
    def test_delete_consultant_database_error(self, mock_error, mock_session):
        ...
        assert result is False
        mock_error.assert_called_with("❌ Erreur lors de la suppression du consultant: Database error")
...
class TestShowForms:
    ...
    def test_show_add_form_no_practices(self, mock_warning, mock_markdown, mock_session):
        ...
        mock_warning.assert_called_with("⚠️ Aucune practice trouvée. Veuillez créer des practices d'abord.")
