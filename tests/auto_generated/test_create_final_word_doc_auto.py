"""
Tests automatiquement générés pour docs/create_final_word_doc.py
...
try:
    from docs.create_final_word_doc import *
except ImportError as e:
    pytest.skip(f"Cannot import docs.create_final_word_doc: {e}", allow_module_level=True)
