...
class TestConsultantModel:
    ...
    def test_consultant_creation_basic(self):
        ...
        consultant = Consultant(nom="Dupont", prenom="Jean", email="jean.dupont@test.com")
...
class TestMissionModel:
    ...
    def test_mission_duration_calculation(self):
        ...
        mission = Mission(date_debut=date(2024, 1, 1), date_fin=date(2024, 1, 31))
...
class TestCompetenceModel:
    ...
    def test_competence_creation(self):
        ...
        competence = Competence(nom="Python", categorie="Backend", niveau_requis="junior")
...
class TestBusinessManagerModel:
    ...
    def test_business_manager_creation(self):
        ...
        bm = BusinessManager(nom="Manager", prenom="Test", email="manager@test.com")
...
class TestPracticeModel:
    ...
    def test_practice_creation(self):
        ...
        practice = Practice(nom="Data Science", description="Practice Data Science et IA")
